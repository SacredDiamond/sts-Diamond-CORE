...
public class cardTemplate extends AbstractDynamicCard {
    ...
    // public static final String ID = DiamondCore.makeID(${NAME}.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String ID = DiamondCore.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
