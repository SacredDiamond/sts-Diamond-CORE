...
public class RelicSpeech extends AbstractGameEffect {
	...
	public RelicSpeech(float x, float y, String msg)
	{
		this(x, y, 3.5F, msg);
	}

	public RelicSpeech(float x, float y, float duration, String msg)
	{
		this.x = x + ADJUST_X;
		this.y = y - ADJUST_Y;
